...
SERVER = 'DESKTOP-NPKCIGP'  # Nombre del servidor exactamente como aparece
DATABASE = 'NombreDeTuBaseDeDatos'  # Reemplaza con el nombre de tu BD
USERNAME = 'sa'  # Usuario
PASSWORD = '147852'  # La contraseña que usas en SSMS
